...
class ResponseTest extends ResponseTestCase
{
    ...
    public function testGetReferenceUniversResponse()
    {
        ...
        $referenceUniversClientMock = new GetReferenceUniversMock($serializer);

        $response = $referenceUniversClientMock->getResponse([]);
        ...
        $this->assertElementsAreIndexed($universCollection, $firstUniversOfCollection, 'getId');
